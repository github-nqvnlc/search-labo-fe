...
const Titan = ({ labo }: { labo?: Labo }) => {
  return (
    <div className="relative rounded-xl border bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-900 dark:shadow-neutral-700/70">
      ...
      <p className="absolute left-[23%] top-[79.3%] text-xs font-semibold text-gray-800 md:top-[75.8%] md:text-lg">
      ...
      <div className="absolute right-[3%] top-[3%] size-6 border"></div>
    </div>
  )
}
